...
namespace ERP.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            comments.CreateChildPermission(AppPermissions.Pages_Comments_Delete, L("DeleteComment"), multiTenancySides: MultiTenancySides.Host);
            ...
            polls.CreateChildPermission(AppPermissions.Pages_Polls_Delete, L("DeletePoll"), multiTenancySides: MultiTenancySides.Host);
